...
public class MemberController {
	...
	public String createForm(Model model) {
		...
		queryMap.put("query2", "데이터베이스 개론");
		queryMap.put("query3", "데이터베이스 개론");
		queryMap.put("query4", "만들면서 배우는 생성 AI");
		queryMap.put("query5", "면접을 위한 CS 전공지식 노트");
		queryMap.put("query6", "웹디자인기능사 실기 7일 완성");
		queryMap.put("query7", "2023 이기적 정보처리기능사 필기 기출문제집");
		queryMap.put("query8", "레트로의 유니티 게임 프로그래밍 에센스");
		queryMap.put("query9", "피, 땀, 픽셀");
		queryMap.put("query10", "진짜 쓰는 프리미어 프로 영상 편집");
		queryMap.put("query11", "디버깅을 통해 배우는 리눅스 커널의 구조와 원리(2)");
		queryMap.put("query12", "모두를 위한 클라우드 컴퓨팅");
		queryMap.put("query13", "IT 엔지니어를 위한 네트워크 입문");
		queryMap.put("query14", "세상에서 가장 쉬운 코딩책");
		queryMap.put("query15", "혼자 공부하는 컴퓨터구조");
		queryMap.put("query16", "챗GPT사용법");
		queryMap.put("query17", "누구나 가능한 유닉스&리눅스 2편");
		queryMap.put("query18", "웹 개발자 로드맵");
		...
		String query18 = queryMap.get("query18");
		...
		ResponseEntity<String> resp18 = booksearch.callNaverApi(clientId, clientSecret, query18);
		...
		booksearch.resultBook(resp18.getBody());
		return "join/join";
	}
